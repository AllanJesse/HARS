...
<input type = "text" value="<?php echo $user_firstname; ?>" class = "form-control" name = "fname">
</div>
...
<input type = "text" class = "form-control" value="<?php echo $username; ?>" name = "uname">
</div>
...
<input type = "password" value="<?php echo $user_password; ?>" class = "form-control" name = "pass">
</div>
