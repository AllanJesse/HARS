    ...
    <div class="modal-content">
      ...
      <form action="" method="post">
        ...
        <div class="form-group">
          ...
          <input name="phone number" type="number" class="form-control" placeholder="Enter your Phone Number">    
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for = "title">Choose Payment Method</label>
          <br>
        ...
        <div class="form-group">
          <label for="user_email">Card Details</label>
          <input name="user_email" type="email" class="form-control" placeholder="Enter your card number eg.cvv 369" maxlength="3">   
          <br>
